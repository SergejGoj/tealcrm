...
/*
 * Dutch bank company numbers (not 'giro' numbers) have 9 digits
...
jQuery.validator.addMethod("bankaccountNL", function(value, element) {
	...
	// now '11 check'
	var company = value.replace(/ /g, ""), // remove spaces
		sum = 0,
		len = company.length,
		pos, factor, digit;
	for ( pos = 0; pos < len; pos++ ) {
		factor = len - pos;
		digit = company.substring(pos, pos + 1);
		sum = sum + factor * digit;
	}
	return sum % 11 === 0;
}, "Please specify a valid bank company number");

jQuery.validator.addMethod("bankorgiroaccountNL", function(value, element) {
	return this.optional(element) ||
			($.validator.methods.bankaccountNL.call(this, value, element)) ||
			($.validator.methods.giroaccountNL.call(this, value, element));
}, "Please specify a valid bank or giro company number");
...
/**
 * Dutch giro company numbers (not bank numbers) have max 7 digits
 */
jQuery.validator.addMethod("giroaccountNL", function(value, element) {
	return this.optional(element) || /^[0-9]{1,7}$/.test(value);
}, "Please specify a valid giro company number");

/**
 * IBAN is the international bank company number.
