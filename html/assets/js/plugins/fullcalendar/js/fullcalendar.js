...
function AgendaEventRenderer() {
	...
	// overrides DayEventRenderer's version because it needs to company for dragging elements
	...
	function resizableSlotEvent(event, eventElement, timeElement) {
		...
		eventElement.resizable({
			...
			resize: function(ev, ui) {
				// don't rely on ui.size.height, doesn't take grid into company
...
function View(element, calendar, viewName) {
	...
	//    Keep in mind that column indices are inverted with isRTL. This is taken into company.
	//
	...
	function calculateVerticals(segments) {
		...
		for (var rowI=0; rowI<rowCnt; rowI++) {
			...
			for (var segmentI=0; segmentI<segmentRow.length; segmentI++) {
				...
				// adjust the columns to company for the segment's height
