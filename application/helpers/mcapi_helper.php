...
class MCAPI {
    ...
    /**
     * Create a new draft campaign to send. You <strong>can not</strong> have more than 32,000 campaigns in your company.
     *
     * @section Campaign  Related
     ...
     * @param array $options a hash of the standard options for this campaign :
            ...
            array tracking optional - set which recipient actions will be tracked, as a struct of boolean values with the following keys: "opens", "html_clicks", and "text_clicks".  By default, opens and HTML clicks will be tracked. Click tracking can not be disabled for Free companies.
            ...
            boolean auto_tweet optional If set, this campaign will be auto-tweeted when it is sent - defaults to false. Note that if a Twitter company isn't linked, this will be silently ignored.
    ...
    */
     ...
     * @param array  $opts optional various parameters which can be used to configure the shared report
            ...
            string  header_data optional - if "header_type" is text, the text to display. if "header_type" is "image" a valid URL to an image file. Note that images will be resized to be no more than 500x150. Defaults to the Companies Company Name.
    ...
    /**
     * Retrieve all of the lists defined for your user company
     *
     ...
     * @param array $merge_vars optional merges for the email (FNAME, LNAME, etc.) (see examples below for handling "blank" arrays). Note that a merge field can only hold up to 255 bytes. Also, there are a few "special" keys:
                        ...
                        string OPTINIP Set the Opt-in IP fields. <em>Abusing this may cause your company to be suspended.</em> We do validate this and it must not be a private IP address.
                        ...
                        string phone If your company has the US Phone numbers option set, this <em>must</em> be in the form of NPA-NXX-LINE (404-555-1212). If not, we assume an International number and will simply set the field with what ever number is passed in.
     ...
     * @param bool $double_optin optional flag to control whether a double opt-in confirmation message is sent, defaults to true. <em>Abusing this may cause your company to be suspended.</em>
     ...
     * @returnf array data an array of arrays where each one has member info:
            string id The unique id for this email address on an company
     ...
     * @param array $types optional the types of templates to return
                        boolean user    Customer template for this user company. Defaults to true.
    ...
    /**
     * Retrieve lots of company information including payments made, plan info, some company stats, installed modules,
     * contact info, and more. No private information like Credit Card numbers is available.
     *
     * @section Helper
     *
     * @return array containing the details for the company tied to this API Key
     * @returnf string username The Company username
     * @returnf string user_id The Company user unique id (for building some links)
     * @returnf bool is_trial Whether the Company is in Trial mode (can only send campaigns to less than 100 emails)
     * @returnf string timezone The timezone for the Company - default is "US/Eastern"
     ...
     * @returnf int emails_left <em>only for Free and Pay-as-you-go plans</em> emails credits left for the company
     * @returnf bool pending_monthly Whether the company is finishing Pay As You Go credits before switching to a Monthly plan
     * @returnf string first_payment date of first payment
     * @returnf string last_payment date of most recent payment
     * @returnf int times_logged_in total number of times the company has been logged into via the web
     ...
     * @returnf array contact Contact details for the company
     ...
     * @returnf array modules Addons installed in the company
            string name The module name
            string added The date the module was added
     * @returnf array orders Order details for the company
     ...
     * @returnf array rewards Rewards details for the company including credits & inspections earned, number of referals, referal details, and rewards used
     ...
     * @param mixed $content The content to use. For "html" expects  a single string value, "template" expects an array like you send to campaignCreate, "url" expects a valid & public URL to pull from, "cid" expects a valid Campaign Id, and "tid" expects a valid Template Id on your company.
    ...
    /**
     * List all the folders for a user company
     *
    ...
    /**
     * Retrieve the Ecommerce Orders for an company
     *
     * @section Ecommerce
     *
     * @param int $start optional for large data sets, the page number to start at - defaults to 1st page of data  (page 0)
    ...
    /**
     * Return the current Chimp Chatter messages for an company.
     *
     * @section Helper
     *
    ...
    /**
     * Add an API Key to your company. We will generate a new key for you and return it.
     *
     * @section Security Related
     * @example xml-rpc_apikeyAdd.php
     *
    ...
    /**
     * Expire a Specific API Key. Note that if you expire all of your keys, just visit <a href="http://admin.mailchimp.com/company/api" target="_blank">your API dashboard</a>
     * to create a new one. If you are trying to shut off access to your company for an old developer, change your
