...
*/
$config['tables']['users']           = 'sc_users';
$config['tables']['groups']          = 'sc_groups';
$config['tables']['users_groups']    = 'sc_users_groups';
$config['tables']['login_attempts']  = 'sc_login_attempts';
 ...
 */
$config['site_title']                 = "TealCRM";       // Site Title, example.com
