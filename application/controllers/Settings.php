...
class Settings extends App_Controller
{
    ...
    public function products($action = 0, $id = NULL)
    {
        ...
        if (is_numeric($action)) {
            ...
            switch ($action) {
                case 'edit':
                    $this->products_edit($id);
                    break;
                case 'add':
                    $this->products_add();
                    break;
                case 'delete':
                    $this->products_delete($id);
                    break;
            }
    ...
    public function templates($action = NULL, $id = NULL)
    {
        ...
        if ($action == NULL) {
            ...
            switch ($action) {
                case 'edit':
                    $this->proposal_edit($id);
                    break;
                case 'add':
                    $this->proposal_add();
                    break;
                case 'delete':
                    $this->proposal_delete($id);
                    break;
            }
    ...
    private function proposal_edit($id)
    {
        ...
        if ('save' == $this->input->post('act', true)) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                notify_set(array('status' => 'error', 'message' => ' The HTML Template is empty.'));
            }
            redirect('settings/templates');
        }
...
//            }
            ...
            $this->modules->add_fields_list($type, $field_list);
        }
...
//        $company_updated_fields = $this->db->get()->result();
        $company_updated_fields = $this->modules->get_fields_list("companies");
...
//        $people_updated_fields = $this->db->get()->result();
        $people_updated_fields = $this->modules->get_fields_list("people");
...
//        $deal_updated_fields = $this->db->get()->result();
        $deal_updated_fields = $this->modules->get_fields_list("deals");
...
//        $note_updated_fields = $this->db->get()->result();
        $note_updated_fields = $this->modules->get_fields_list("notes");
...
//        $proposal_updated_fields = $this->db->get()->result();
        $proposal_updated_fields = $this->modules->get_fields_list("proposals");
...
//        $task_updated_fields = $this->db->get()->result();
        $task_updated_fields = $this->modules->get_fields_list("tasks");
...
//        $meeting_updated_fields = $this->db->get()->result();
        $meeting_updated_fields = $this->modules->get_fields_list("meetings");
