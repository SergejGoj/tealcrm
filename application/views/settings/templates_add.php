  ...
  <div>
    ...
    <div class="portlet">
      ...
      <h2 class="portlet-title">
        <u>Add New Template</u>
      </h2>

      <div class="portlet-body">

        <form name="frmpass" id="frmpass" action="<?php echo site_url('settings/templates/add')?>" method="post" class="form parsley-form">

  			<div class="form-group">
				<label for="subject">Name</label>
				<input type="text" name="name" id="name" class="form-control"  placeholder="Enter name of template">
			</div>
