                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <ul class="connectedSortable">
                                                ...
                                                <?php foreach ($company_fields as $cmp_field) {
                                                    ...
                                                    if ($chk != 0) {
                                                        ?>
                                                        <li id="<?php echo $cmp_field; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($cmp_field); ?></li>
                                                    <?php }
                                                }
                                                ...
                                                if (isset($custom_field_values))
                                                    foreach ($custom_field_values as $cmp_cus) {
                                                        ...
                                                        if ($chk1 != 0) {
                                                            ?>
                                                            <li id="<?php echo $cmp_cus['cf_name']; ?>"
                                                                class="ui-state-default"><?php echo $cmp_cus['cf_name']; ?></li>
                                                        <?php }
                                                    } ?>
                                            </ul>
                                        </div>
                                        <div class="col-md-5">
                                            <h4>Drop Fields Here <span
                                                        style="font-size:12px;">(Only drop 5 field)</span></h4>
                                            <ul id="company_list" class="connectedSortable">
                                                <?php if (isset($company_updated_fields)) {
                                                    foreach ($company_updated_fields as $cmp_up_field) { ?>
                                                        <li id="<?php echo $cmp_up_field->field_name; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($cmp_up_field->field_name); ?></li>
                                                    <?php }
                                                } ?>
                                            </ul>
                                            <div class="list-footer-left">
                                                <button type="button" class="btn btn-success"
                                                        onclick="save_custom('company_list','companies');">Save
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <ul class="connectedSortable">
                                                ...
                                                <?php foreach ($people_fields as $pep_field) {
                                                    ...
                                                    if ($chk != 0) {
                                                        ?>
                                                        <li id="<?php echo $pep_field; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($pep_field); ?></li>
                                                    <?php }
                                                }
                                                ...
                                                if (isset($custom_field_values))
                                                    foreach ($custom_field_values as $pep_cus) {
                                                        ...
                                                        if ($chk1 != 0) {
                                                            ?>
                                                            <li id="<?php echo $pep_cus['cf_name']; ?>"
                                                                class="ui-state-default"><?php echo $pep_cus['cf_name']; ?></li>
                                                        <?php }
                                                    } ?>
                                            </ul>
                                        </div>
                                            ...
                                            <ul id="people_list" class="connectedSortable">
                                                <?php if (isset($people_updated_fields)) {
                                                    foreach ($people_updated_fields as $pep_up_field) { ?>
                                                        <li id="<?php echo $pep_up_field->field_name; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($pep_up_field->field_name); ?></li>
                                                    <?php }
                                                } ?>
                                            </ul>
                                            <div class="list-footer-left">
                                                <button type="button" class="btn btn-success"
                                                        onclick="save_custom('people_list','people');">Save
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <ul class="connectedSortable">
                                                ...
                                                <?php foreach ($deal_fields as $del_field) {
                                                    ...
                                                    if ($chk != 0) {
                                                        ?>
                                                        <li id="<?php echo $del_field; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($del_field); ?></li>
                                                    <?php }
                                                }
                                                ...
                                                if (isset($custom_field_values))
                                                    foreach ($custom_field_values as $del_cus) {
                                                        ...
                                                        if ($chk1 != 0) {
                                                            ?>
                                                            <li id="<?php echo $del_cus['cf_name']; ?>"
                                                                class="ui-state-default"><?php echo $del_cus['cf_name']; ?></li>
                                                        <?php }
                                                    } ?>
                                            </ul>
                                        </div>
                                            ...
                                            <ul id="deal_list" class="connectedSortable">
                                                <?php if (isset($deal_updated_fields)) {
                                                    foreach ($deal_updated_fields as $del_up_field) { ?>
                                                        <li id="<?php echo $del_up_field->field_name; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($del_up_field->field_name); ?></li>
                                                    <?php }
                                                } ?>
                                            </ul>
                                            <div class="list-footer-left">
                                                <button type="button" class="btn btn-success"
                                                        onclick="save_custom('deal_list','deals');">Save
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <ul class="connectedSortable">
                                                ...
                                                <?php foreach ($note_fields as $not_field) {
                                                    ...
                                                    if ($chk != 0) {
                                                        ?>
                                                        <li id="<?php echo $not_field; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($not_field); ?></li>
                                                    <?php }
                                                }
                                                ...
                                                if (isset($custom_field_values))
                                                    foreach ($custom_field_values as $not_cus) {
                                                        ...
                                                        if ($chk1 != 0) {
                                                            ?>
                                                            <li id="<?php echo $not_cus['cf_name']; ?>"
                                                                class="ui-state-default"><?php echo $not_cus['cf_name']; ?></li>
                                                        <?php }
                                                    } ?>
                                            </ul>
                                        </div>
                                            ...
                                            <ul id="note_list" class="connectedSortable">
                                                <?php if (isset($note_updated_fields)) {
                                                    foreach ($note_updated_fields as $not_up_field) { ?>
                                                        <li id="<?php echo $not_up_field->field_name; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($not_up_field->field_name); ?></li>
                                                    <?php }
                                                } ?>
                                            </ul>
                                            <div class="list-footer-left">
                                                <button type="button" class="btn btn-success"
                                                        onclick="save_custom('note_list','notes');">Save
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <ul class="connectedSortable">
                                                ...
                                                <?php foreach ($task_fields as $tak_field) {
                                                    ...
                                                    if ($chk != 0) {
                                                        ?>
                                                        <li id="<?php echo $tak_field; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($tak_field); ?></li>
                                                    <?php }
                                                }
                                                ...
                                                if (isset($custom_field_values))
                                                    foreach ($custom_field_values as $tak_cus) {
                                                        ...
                                                        if ($chk1 != 0) {
                                                            ?>
                                                            <li id="<?php echo $tak_cus['cf_name']; ?>"
                                                                class="ui-state-default"><?php echo $tak_cus['cf_name']; ?></li>
                                                        <?php }
                                                    } ?>
                                            </ul>
                                        </div>
                                            ...
                                            <ul id="task_list" class="connectedSortable">
                                                <?php if (isset($task_updated_fields)) {
                                                    foreach ($task_updated_fields as $tak_up_field) { ?>
                                                        <li id="<?php echo $tak_up_field->field_name; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($tak_up_field->field_name); ?></li>
                                                    <?php }
                                                } ?>
                                            </ul>
                                            <div class="list-footer-left">
                                                <button type="button" class="btn btn-success"
                                                        onclick="save_custom('task_list','tasks');">Save
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <ul class="connectedSortable">
                                                ...
                                                <?php foreach ($meeting_fields as $met_field) {
                                                    ...
                                                    if ($chk != 0) {
                                                        ?>
                                                        <li id="<?php echo $met_field; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($met_field); ?></li>
                                                    <?php }
                                                }
                                                ...
                                                if (isset($custom_field_values))
                                                    foreach ($custom_field_values as $met_cus) {
                                                        ...
                                                        if ($chk1 != 0) {
                                                            ?>
                                                            <li id="<?php echo $met_cus['cf_name']; ?>"
                                                                class="ui-state-default"><?php echo $met_cus['cf_name']; ?></li>
                                                        <?php }
                                                    } ?>
                                            </ul>
                                        </div>
                                            ...
                                            <ul id="meeting_list" class="connectedSortable">
                                                <?php if (isset($meeting_updated_fields)) {
                                                    foreach ($meeting_updated_fields as $met_up_field) { ?>
                                                        <li id="<?php echo $met_up_field->field_name; ?>"
                                                            class="ui-state-default"><?php echo $this->lang->line($met_up_field->field_name); ?></li>
                                                    <?php }
                                                } ?>
                                            </ul>
                                            <div class="list-footer-left">
                                                <button type="button" class="btn btn-success"
                                                        onclick="save_custom('meeting_list','meetings');">Save
                                                </button>
                                            </div>
                                        </div>
                                    </div>
