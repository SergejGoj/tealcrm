<div class="row">
        ...
        <div class="col-md-3 col-sm-5">
          ...
          <div class="profile-avatar">
            <img src="admin/img/avatars/avatar-2-lg.jpg" class="profile-avatar-img thumbnail" alt="Profile Image">
          </div> <!-- /.profile-avatar -->
            ...
            <div class="feed-item feed-item-image">
              ...
              <div class="feed-content">
                <div class="thumbnail" style="width: 375px">
                  <img src="admin/img/mockup.png" style="width: 100%;" alt="Gallery Image">
                </div> <!-- /.thumbnail -->
              </div> <!-- /.feed-content -->
