...
class Flexi_auth_lite
{
	...
	/**
	 * logout
	 * Logs a user out of their company.
	 ...
	 * Gets data from the user company table and any custom tables that have been related to it by submitting the users id.
	 *
	 * @return object
	 * @author Rob Hussey
	 */
	 ...
	 * Gets data from the user company table and any custom tables that have been related to it by submitting the users identity.
	 *
	 * @return object
	 * @author Rob Hussey
	 */
	...
	/**
	 * get_users_query
	 * Gets data from the user company table and any custom tables that have been related to it.
